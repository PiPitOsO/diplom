...
[Интеграционный тест](src/test/java/NetologyCloudStorageApplicationTests.java) и
[JPA тесты](src/test/java/repository) (StorageFileRepositoryTest.java, UserRepositoryTest.java)
...
BACKEND можно запустить и через main метод в классе start.NetologyCloudStorageApplication.java,
